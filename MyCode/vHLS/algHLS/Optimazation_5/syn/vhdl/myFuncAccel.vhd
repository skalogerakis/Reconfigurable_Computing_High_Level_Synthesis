...
architecture behav of myFuncAccel is 
    ...
    "myFuncAccel,hls_ip_2018_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=4055,HLS_SYN_TPT=4038,HLS_SYN_MEM=0,HLS_SYN_DSP=23,HLS_SYN_FF=5087,HLS_SYN_LUT=5966,HLS_VERSION=2018_3}";
