...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.myFuncAccel.autotvin_size.dat"
         "c.myFuncAccel.autotvin_dim.dat"
         "c.myFuncAccel.autotvin_threshold.dat"
         "c.myFuncAccel.autotvin_data0.dat"
         "c.myFuncAccel.autotvin_data1.dat"
         "c.myFuncAccel.autotvin_data2.dat"
         "c.myFuncAccel.autotvout_data2.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.myFuncAccel.autotvout_data2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
