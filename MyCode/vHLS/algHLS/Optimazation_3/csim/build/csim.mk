# ==============================================================
# File generated on Thu Nov 21 14:15:26 EET 2019
...
$(ObjDir)/myAccel.o: ../../../../../myAccel.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../../../myAccel.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/myAccel.d
