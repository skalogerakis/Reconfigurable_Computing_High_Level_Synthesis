...
HD_PWD='/home/skalogerakis/TUC_Projects/TUC_HLS/MyCode/MIlestone3/SDSOC_Accel/Algo_4/Debug/_sds/p0/vivado/prj/prj.runs/zed_auto_pc_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zed_auto_pc_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zed_auto_pc_2.tcl
