...
//	   we allocate memory using sds_alloc for data going to the hardware functions (data0, data1, data2)
//		to insure physically contiguous memory is allocated
	...
	/**************************************************************************/
	dataType_t * data2 = (dataType_t *)sds_alloc(sizeof(dataType_t)*dim*size);
	/**************************************************************************/
...
//#pragma SDS resource(1)
	...
	/**************************************************************************/
	p_0_myFuncAccel_1_noasync (size, dim, threshold, data0, data1, data2_hw);
	/**************************************************************************/
