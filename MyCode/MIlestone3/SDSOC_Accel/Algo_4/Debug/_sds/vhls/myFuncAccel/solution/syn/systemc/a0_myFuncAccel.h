...
#ifndef _a0_myFuncAccel_HH_
#define _a0_myFuncAccel_HH_
...
struct a0_myFuncAccel : public sc_module {
    ...
    // Module declarations
    a0_myFuncAccel(sc_module_name name);
    SC_HAS_PROCESS(a0_myFuncAccel);
    ...
    sc_signal< sc_logic > Block_codeRepl49_pro_U0_ap_start;
    sc_signal< sc_logic > Block_codeRepl49_pro_U0_ap_done;
    sc_signal< sc_logic > Block_codeRepl49_pro_U0_ap_continue;
    sc_signal< sc_logic > Block_codeRepl49_pro_U0_ap_idle;
    sc_signal< sc_logic > Block_codeRepl49_pro_U0_ap_ready;
    sc_signal< sc_logic > Block_codeRepl49_pro_U0_data0_read;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_size_out_din;
    sc_signal< sc_logic > Block_codeRepl49_pro_U0_size_out_write;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_threshold_out_din;
    sc_signal< sc_logic > Block_codeRepl49_pro_U0_threshold_out_write;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_0;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_1;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_2;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_3;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_4;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_5;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_6;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_7;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_8;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_9;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_10;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_11;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_12;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_13;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_14;
    sc_signal< sc_lv<32> > Block_codeRepl49_pro_U0_ap_return_15;
    ...
    sc_signal< sc_logic > Loop_sizeLoop_proc_U0_size_read;
    sc_signal< sc_logic > Loop_sizeLoop_proc_U0_data1_read;
    sc_signal< sc_logic > Loop_sizeLoop_proc_U0_threshold_read;
    sc_signal< sc_lv<32> > Loop_sizeLoop_proc_U0_data2_din;
    sc_signal< sc_logic > Loop_sizeLoop_proc_U0_data2_write;
    ...
    sc_signal< sc_logic > ap_sync_reg_Block_codeRepl49_pro_U0_ap_ready;
    sc_signal< sc_logic > ap_sync_Block_codeRepl49_pro_U0_ap_ready;
    sc_signal< sc_lv<2> > Block_codeRepl49_pro_U0_ap_ready_count;
    ...
    sc_signal< sc_logic > Block_codeRepl49_pro_U0_start_full_n;
    sc_signal< sc_logic > Block_codeRepl49_pro_U0_start_write;
    ...
    void thread_Block_codeRepl49_pro_U0_ap_continue();
    void thread_Block_codeRepl49_pro_U0_ap_start();
    void thread_Block_codeRepl49_pro_U0_start_full_n();
    void thread_Block_codeRepl49_pro_U0_start_write();
    ...
    void thread_ap_sync_Block_codeRepl49_pro_U0_ap_ready();
