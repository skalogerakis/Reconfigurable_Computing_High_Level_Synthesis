// ==============================================================
// File generated on Sat Nov 23 03:38:20 EET 2019
...
`define AUTOTB_TVIN_data0  "./c.myFuncAccel.autotvin_data0.dat"
`define AUTOTB_TVIN_data1  "./c.myFuncAccel.autotvin_data1.dat"
`define AUTOTB_TVIN_data2  "./c.myFuncAccel.autotvin_data2.dat"
`define AUTOTB_TVIN_data0_out_wrapc  "./rtl.myFuncAccel.autotvin_data0.dat"
`define AUTOTB_TVIN_data1_out_wrapc  "./rtl.myFuncAccel.autotvin_data1.dat"
`define AUTOTB_TVIN_data2_out_wrapc  "./rtl.myFuncAccel.autotvin_data2.dat"
`define AUTOTB_TVOUT_data2  "./c.myFuncAccel.autotvout_data2.dat"
`define AUTOTB_TVOUT_data2_out_wrapc  "./impl_rtl.myFuncAccel.autotvout_data2.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 16368;
parameter LENGTH_data0 = 256;
parameter LENGTH_data1 = 16000;
parameter LENGTH_data2 = 16000;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.myFuncAccel.autotvout_data2.dat", "r");
    fp2 = $fopen("./impl_rtl.myFuncAccel.autotvout_data2.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.myFuncAccel.autotvout_data2.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.myFuncAccel.autotvout_data2.dat\"!");
    else begin
        $display("Comparing rtl.myFuncAccel.autotvout_data2.dat with impl_rtl.myFuncAccel.autotvout_data2.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
