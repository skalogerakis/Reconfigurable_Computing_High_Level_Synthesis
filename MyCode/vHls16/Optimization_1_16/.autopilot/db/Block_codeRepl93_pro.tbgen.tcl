set moduleName Block_codeRepl93_pro
...
set C_modelName {Block_codeRepl93_pro}
set C_modelType { int 8000 }
set C_modelArgList {
	{ data0 float 32 regular {bus 0}  }
	{ empty float 32 regular {array 256 { 0 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "data0", "interface" : "bus", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "empty", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "ap_return", "interface" : "wire", "bitwidth" : 8000} ]}
...
set portList { 
	...
	{ data0_req_din sc_out sc_logic 1 signal 0 } 
	{ data0_req_full_n sc_in sc_logic 1 signal 0 } 
	{ data0_req_write sc_out sc_logic 1 signal 0 } 
	{ data0_rsp_empty_n sc_in sc_logic 1 signal 0 } 
	{ data0_rsp_read sc_out sc_logic 1 signal 0 } 
	{ data0_address sc_out sc_lv 32 signal 0 } 
	{ data0_datain sc_in sc_lv 32 signal 0 } 
	{ data0_dataout sc_out sc_lv 32 signal 0 } 
	{ data0_size sc_out sc_lv 32 signal 0 } 
	{ empty_address0 sc_out sc_lv 8 signal 1 } 
	{ empty_ce0 sc_out sc_logic 1 signal 1 } 
	{ empty_we0 sc_out sc_logic 1 signal 1 } 
	{ empty_d0 sc_out sc_lv 32 signal 1 } 
	{ empty_address1 sc_out sc_lv 8 signal 1 } 
	{ empty_ce1 sc_out sc_logic 1 signal 1 } 
	{ empty_we1 sc_out sc_logic 1 signal 1 } 
	{ empty_d1 sc_out sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "empty_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "empty", "role": "address0" }} , 
 	{ "name": "empty_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "empty", "role": "ce0" }} , 
 	{ "name": "empty_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "empty", "role": "we0" }} , 
 	{ "name": "empty_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "empty", "role": "d0" }} , 
 	{ "name": "empty_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "empty", "role": "address1" }} , 
 	{ "name": "empty_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "empty", "role": "ce1" }} , 
 	{ "name": "empty_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "empty", "role": "we1" }} , 
 	{ "name": "empty_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "empty", "role": "d1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "empty", "Type" : "Memory", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"}]}]}
...
set Spec2ImplPortList { 
	...
	empty { ap_memory {  { empty_address0 mem_address 1 8 }  { empty_ce0 mem_ce 1 1 }  { empty_we0 mem_we 1 1 }  { empty_d0 mem_din 1 32 }  { empty_address1 MemPortADDR2 1 8 }  { empty_ce1 MemPortCE2 1 1 }  { empty_we1 MemPortWE2 1 1 }  { empty_d1 MemPortDIN2 1 32 } } }
}
