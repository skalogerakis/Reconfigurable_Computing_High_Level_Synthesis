# ==============================================================
# File generated on Sat Nov 23 03:38:19 EET 2019
...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe 1000 1000 16 100 | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "myFuncAccel.autotvin.dat"
	set constFileTvOut       "myFuncAccel.autotvout.dat"
	set constFileHdlTvIn     "myFuncAccel.autohdltvin.dat"
	set constFileHdlTvOut    "myFuncAccel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
