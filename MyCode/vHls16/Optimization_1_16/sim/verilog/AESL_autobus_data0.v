...
module AESL_autobus_data0 #(
	parameter DATA_WIDTH = 32'd32,
	parameter ADDR_WIDTH = 32'd32,
	parameter DEPTH = 32'd256,
	parameter FIFO_rsp_DEPTH = 32'd256,
	parameter FIFO_req_DEPTH = 32'd32,
	parameter mem_page_num = 32'd4) (
	input clk,
	input rst,
	input bus_req_RW,
	...
	localparam TV_IN  = "../tv/cdatafile/c.myFuncAccel.autotvin_data0.dat";
	localparam TV_OUT = "../tv/rtldatafile/rtl.myFuncAccel.autotvout_data0.dat";
	...
	assign bus_rsp_empty_n = ~rsp_empty;
	    ...
	    reg [DATA_WIDTH - 1:0] mem_3 [0:DEPTH - 1];
		...
		forever begin
			...
			while (pending_write && ~fifo_req.empty) begin
				...
				if (pending_address < DEPTH) begin
					    ...
					    3 : mem_3[pending_address] = req_din;
			...
			while (pending_read && ~fifo_rsp.full) begin
				if (pending_address < DEPTH) begin
					    ...
					    3 : rsp_dout = mem_3[pending_address];
			...
			if (token != "[[[/runtime]]]") begin
				...
				for (i = 0; i < DEPTH; i = i + 1) begin
					token = read_token(fp);
					    ...
					    3 : ret = $sscanf(rm_0x(token), "%x", mem_3[i]);
