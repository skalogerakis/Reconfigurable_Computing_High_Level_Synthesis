...
HLS_SOURCES = ../../../../main.c ../../../../myAccel16.c
...
$(ObjDir)/myAccel16.o: ../../../../myAccel16.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../../myAccel16.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/myAccel16.d
